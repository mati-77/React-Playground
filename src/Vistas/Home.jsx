        ...
        <Fragment>
            <main className="home d-flex flex-column justify-content-evenly">
                    ...
                    <section className="proyecto">
                        <div className="d-flex flex-column justify-content-evenly ps-3 pe-3 border border-light rounded text-light h-100">
                            ...
                            <div className="enlacesProyecto">
                                <a href="https://github.com/mati-77/React-Playground/blob/main/src/Vistas/SimonDice.jsx" target="_blank" rel="noreferrer">Ver código</a>
                                <Link to="/simon">Ver proyecto</Link>
                            </div>
                        </div>
                    </section>
                    <section className="proyecto">
                        <div className="d-flex flex-column justify-content-evenly ps-3 pe-3 border border-light rounded text-light h-100">
                            ...
                            <div className="enlacesProyecto">
                                <a href="https://github.com/mati-77/React-Playground/blob/main/src/Vistas/Buscador.jsx" target="_blank" rel="noreferrer">Ver código</a>
                                <Link to="/buscador" onClick={window.scrollTo(0, 0)}>Ver proyecto</Link>
                            </div>
                        </div>
                    </section>
                </div>
                ...
                <section className="d-flex justify-content-around mb-4">
                    ...
                    <a className="d-flex flex-column justify-content-center align-items-center text-decoration-none text-light" href="https://github.com/mati-77" target="_blank" rel="noreferrer">
